...
class Question {
	 ...
	 */
 	public function addQuestion($questionAdded){
		...
		$last_updated_by = $questionAdded['last_updated_by'];
	 ...
	 * @param: questionSerNum
	 * @return quesitonDetails as an array
	 */
	...
	/* Update question
	 * @param: questionArray with details of indicated question
	 * @return response - message states whether action whether succeed or fail
	 */
	public function updateQuestion($questionArray) {
		$serNum = $questionArray['serNum'];
		$text_EN = $questionArray['text_EN'];
		$text_FR = $questionArray['text_FR'];
		$answertype_serNum = $questionArray['answertype_serNum'];
		$questiongroup_serNum = $questionArray['questiongroup_serNum'];
		$last_updated_by = $questionArray['last_updated_by'];
