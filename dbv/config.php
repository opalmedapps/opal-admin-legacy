 ...
 */
define('DB_HOST', OPAL_DB_HOST);
define('DB_PORT', OPAL_DB_PORT);
define('DB_USERNAME', OPAL_DB_USERNAME);
define('DB_PASSWORD', OPAL_DB_PASSWORD);
define('DB_NAME', OPAL_DB_NAME);
