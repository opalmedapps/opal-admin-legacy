...
$delayedLabs = fetchDelayedLabResults();
createNotificationsForDelayedLabs($delayedLabs);

// TODO: Send notifications in loop; ensure notification is not read
 ...
 */
function fetchDelayedLabResults()
{
    global $pdo;
...
function createNotificationsForDelayedLabs($delayedLabs)
{
    global $pdo;
