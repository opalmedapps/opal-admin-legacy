 ...
 *******************************************************************************/
controller('post.add', function ($scope, $filter, $state, $sce, $uibModal, $locale, aliasCollectionService, filterCollectionService, Session) {
	...
	$scope.submitPost = function () {
		if ($scope.checkForm()) {
			...
			$scope.newPost.user = Session.retrieveObject('user');
			// Submit
			$.ajax({
				type: "POST",
