...
angular.module('opalAdmin', [
	...
	.config(['$urlRouterProvider', '$stateProvider', function ($urlRouterProvider, $stateProvider) {
		...
		$stateProvider
			...
			.state('patient-activity', { url: '/patient-activity', templateUrl: "templates/patient/patient-activity.html", controller: "patientActivity", data: { requireLogin: true } })
			...
			.state('report', { url: '/report', templateUrl: "templates/report/patientReport.html", data: { requireLogin: true } })
