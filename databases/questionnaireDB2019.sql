...
CREATE TABLE IF NOT EXISTS `questionnaireDB2019`.`dictionary` (
  ...
  PRIMARY KEY (`ID`),
  INDEX `idx_dictionary_contentId` (`contentId` ASC) INVISIBLE,
  INDEX `idx_dictionary_deleted` (`deleted` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `questionnaireDB2019`.`language` (
  ...
  `updatedBy` VARCHAR(255) NOT NULL,
  PRIMARY KEY (`ID`),
  INDEX `fk_language_deleted` (`deleted` ASC) INVISIBLE,
...
CREATE TABLE IF NOT EXISTS `questionnaireDB2019`.`question` (
  ...
  PRIMARY KEY (`ID`),
  INDEX `idx_question_deleted` (`deleted` ASC) VISIBLE,
  INDEX `idx_question_OAUserId` (`OAUserId` ASC) VISIBLE,
  INDEX `idx_question_parentId` (`parentId` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `questionnaireDB2019`.`questionnaire` (
  ...
  PRIMARY KEY (`ID`),
  INDEX `idx_questionnaire_deleted` (`deleted` ASC) VISIBLE,
  INDEX `idx_questionnaire_OAUserId` (`OAUserId` ASC) VISIBLE,
  INDEX `idx_questionnaire_parentId` (`parentId` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `questionnaireDB2019`.`section` (
  ...
  `updatedBy` VARCHAR(255) NOT NULL,
  PRIMARY KEY (`ID`),
  INDEX `idx_section_deleted` (`deleted` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `questionnaireDB2019`.`patient` (
  ...
  `updatedBy` VARCHAR(255) NOT NULL,
  PRIMARY KEY (`ID`),
  INDEX `idx_patient_deleted` (`deleted` ASC) INVISIBLE,
  INDEX `idx_patient_hospitalId` (`hospitalId` ASC) INVISIBLE,
  INDEX `idx_patient_externalId` (`externalId` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `questionnaireDB2019`.`questionFeedback` (
  ...
  `updatedBy` VARCHAR(255) NOT NULL,
  PRIMARY KEY (`ID`),
  INDEX `fk_questionFeedback_deleted` (`deleted` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `questionnaireDB2019`.`questionnaireFeedback` (
  ...
  `updatedBy` VARCHAR(255) NOT NULL,
  PRIMARY KEY (`ID`),
  INDEX `idx_questionnaireFeedback` (`deleted` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `questionnaireDB2019`.`tag` (
  ...
  `updatedBy` VARCHAR(255) NOT NULL,
  PRIMARY KEY (`ID`),
  INDEX `idx_tag_deleted` (`deleted` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `questionnaireDB2019`.`library` (
  ...
  `updatedBy` VARCHAR(255) NOT NULL,
  PRIMARY KEY (`ID`),
  INDEX `idx_library_deleted` (`deleted` ASC) VISIBLE,
  INDEX `idx_library_OAUserId` (`OAUserId` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `questionnaireDB2019`.`questionnaireRating` (
  ...
  `updatedBy` VARCHAR(255) NOT NULL,
  PRIMARY KEY (`ID`),
  INDEX `idx_questionnaireRating_deleted` (`deleted` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `questionnaireDB2019`.`answerQuestionnaire` (
  ...
  `updatedBy` VARCHAR(255) NOT NULL,
  PRIMARY KEY (`ID`),
  INDEX `idx_answerQuestionnaire_deleted` (`deleted` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `questionnaireDB2019`.`answer` (
  ...
  `updatedBy` VARCHAR(255) NOT NULL,
  PRIMARY KEY (`ID`),
  INDEX `idx_answer_deleted` (`deleted` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `questionnaireDB2019`.`templateQuestion` (
  ...
  `updatedBy` VARCHAR(255) NOT NULL,
  PRIMARY KEY (`ID`),
  INDEX `idx_templateQuestion_deleted` (`deleted` ASC) VISIBLE,
  INDEX `idx_templateQuestion_OAUserId` (`OAUserId` ASC) VISIBLE,
  INDEX `idx_templateQuestion_parentId` (`parentId` ASC) VISIBLE,
