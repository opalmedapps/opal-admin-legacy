...
angular.module('opalAdmin', [
	...
	.config(['$urlRouterProvider', '$stateProvider', 'USER_ROLES', function ($urlRouterProvider, $stateProvider, USER_ROLES) {
		...
		$stateProvider
			...
			.state('educational-material-add', { url: '/educational-material/add', templateUrl: "templates/educational-material-add.html", controller: "newEduMatController", data: { authorizedRoles: [USER_ROLES.admin], requireLogin: true } })
			...
			.state('hospital-map-add', { url: '/hospital-map/add', templateUrl: "templates/hospital-map-add.html", controller: "newHospitalMapController", data: { authorizedRoles: [USER_ROLES.admin], requireLogin: true } })
			...
			.state('notification-add', { url: '/notification/add', templateUrl: "templates/notification-add.html", controller: "newNotificationController", data: { authorizedRoles: [USER_ROLES.admin], requireLogin: true } })
			...
			.state('test-result-add', { url: '/test-result/add', templateUrl: "templates/test-result-add.html", controller: "newTestResultController", data: { authorizedRoles: [USER_ROLES.admin], requireLogin: true } })
			...
			.state('user-register', { url: '/users/add', templateUrl: "templates/user-add.html", controller: "newUserController", data: { authorizedRoles: [USER_ROLES.admin], requireLogin: true } })
			...
			.state('diagnosis-translation', { url: '/diagnosis-translation', templateUrl: "templates/diagnosis-translation.html", controller: "diagnosisTranslationController", data: { authorizedRoles: [USER_ROLES.admin], requireLogin: true } })
			.state('diagnosis-translation-add', { url: '/diagnosis-translation/add', templateUrl: "templates/diagnosis-translation-add.html", controller: "newDiagnosisTranslationController", data: { authorizedRoles: [USER_ROLES.admin], requireLogin: true } })
			.state('user-activity', { url: '/user-activity', templateUrl: "templates/user-activity.html", controller: "userActivityController", data: { authorizedRoles: [USER_ROLES.admin], requireLogin: true } })
