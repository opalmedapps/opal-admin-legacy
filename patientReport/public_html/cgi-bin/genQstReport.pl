...
# genQstReport: Given a questionnaire name, return the list of patients that have been sent this questionnaire
...
my $sql1="
	...
	WHERE
		...
		AND qc.QuestionnaireName_EN = '$name'";
...
foreach my $r (@$data1){
	...
	$newRec = newQstReport rec(split(',',substr($nextRow,1,-1)));
