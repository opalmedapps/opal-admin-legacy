...
angular.module('opalAdmin', [
	...
	.config(['$urlRouterProvider', '$stateProvider', function ($urlRouterProvider, $stateProvider) {
		...
		$stateProvider
			...
			.state('patients/report/individual', { url: '/patients/report/individual', templateUrl: "templates/patient-report/individual-reports.html", controller: "patientReports", data: { requireLogin: true } })
			.state('patients/report/group', { url: '/patients/report/group', templateUrl: "templates/patient-report/group-reports.html", controller: "groupReports", data: { requireLogin: true } })
