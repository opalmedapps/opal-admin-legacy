...
sub getDoctorInfoFromSourceDB
{
	...
	my $doctorSourceUID      = $Doctor->getDoctorSourceUID();
...
sub inOurDatabase
{
	...
	else {return $ExistingDoctor;} # this is false (ie. doctor does not exist) return empty
}
...
# In the process, insert doctor into our database if it does not exist.
#======================================================================================
sub reassignDoctor
{
	...
	if ($DoctorExists) {
        ...
        my $UpdatedDoctor = $Doctor->compareWith($ExistingDoctor);

        $UpdatedDoctor->updateDatabase();
