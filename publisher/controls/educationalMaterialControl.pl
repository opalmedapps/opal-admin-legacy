...
#---------------------------------------------------------------------------------
# Control script for the sending of educ materials to patients. This script has its
...
$execution_log = dirname($0) . '/../logs/executions_educationalMaterial.log';
$monitor_log = dirname($0) . '/../logs/monitor_log_educationalMaterial.json';
...
print "End Time [educationalMaterialControl]: -->> $current_datetime\n";
