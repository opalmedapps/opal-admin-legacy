angular.module('opalAdmin.controllers.userActivityController', ['ngAnimate', 'ui.bootstrap']).


	controller('userActivityController', function ($scope, $uibModal, userCollectionService) {
