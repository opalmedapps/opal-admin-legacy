...
angular.module('opalAdmin', [
	...
	.config(['$urlRouterProvider', '$stateProvider', function ($urlRouterProvider, $stateProvider) {
		...
		$stateProvider
			...
			.state('patient-administration',{ url: '/patient-administration', templateUrl: "templates/patient-administration/modify.patient.html", controller: "modify.patient", data:{ requireLogin: true } });
