...
angular.module('opalAdmin', [
	...
	.config(['$urlRouterProvider', '$stateProvider', 'USER_ROLES', function ($urlRouterProvider, $stateProvider, USER_ROLES) {
		...
		$stateProvider
			...
			.state('questionnaire-question-type', { url: '/questionnaire/question-type', templateUrl: "templates/questionnaire/question.type.html", controller: "question.type", data: { authorizedRoles: [USER_ROLES.admin], requireLogin: true, accessible: true } })
			.state('questionnaire-question-type-add', { url: '/questionnaire/question-type/add', templateUrl: "templates/questionnaire/add.question.type.html", controller: "question.type.add", data: { authorizedRoles: [USER_ROLES.admin], requireLogin: true, accessible: true } })
