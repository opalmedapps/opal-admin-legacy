          ...
          <div class="col-md-10 animated fadeIn">
            <div class="row main-title">
              <div class="col-md-6 title-content">
                ...
                <h1><strong>Educational Material</strong></h1>
              </div>
              <div class="col-md-6 title-breadcrumbs"> 
                <span><a href="#/">Home</a> <span class="glyphicon glyphicon-menu-right teflon"></span> <strong>Edu Material</strong></span>
              </div>
            </div> 
              ...
              <div class="panel-info">
                <div class="panel-input">
                  <div class="row clearfix" style="margin-bottom: 10px;">
                    <div class="col-md-9">
                      <a style="width:100px;" href="" ng-click="goToAddEducationalMaterial()" class="btn btn-md btn-outline">
                  ...
                  <div id="data-table">
                    <div class="gridStyle" ui-grid="gridOptions" ui-grid-expandable ui-grid-resize-columns style="height:720px"></div>
