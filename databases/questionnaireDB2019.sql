...
CREATE TABLE IF NOT EXISTS `questionnaireDB2019`.`question` (
  ...
  CONSTRAINT `fk_question_legacyTypeId_legacyType`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_question_parentId_question_ID`
...
CREATE TABLE IF NOT EXISTS `questionnaireDB2019`.`questionnaire` (
  ...
  CONSTRAINT `fk_questionnaire_instructions_dictionary_contentId`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_questionnaire_parentId_questionnaire_ID`
    FOREIGN KEY (`parentId`)
...
-- -----------------------------------------------------
-- Table `questionnaireDB2019`.`triggerWord`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `questionnaireDB2019`.`triggerWord` (
  `ID` BIGINT NOT NULL AUTO_INCREMENT,
  `parentTableId` BIGINT NOT NULL,
  `description` BIGINT NOT NULL,
  `order` INT NOT NULL DEFAULT 0,
  PRIMARY KEY (`ID`),
  CONSTRAINT `fk_triggerWord_parentTableId_textBox_ID`
    FOREIGN KEY (`parentTableId`)
    REFERENCES `questionnaireDB2019`.`textBox` (`ID`),
  CONSTRAINT `fk_triggerWord_description_dictionary_contentId`
    FOREIGN KEY (`description`)
    REFERENCES `questionnaireDB2019`.`dictionary` (`contentId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
...
-- -----------------------------------------------------
-- Table `questionnaireDB2019`.`typeTemplate`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `questionnaireDB2019`.`typeTemplate` (
  `ID` BIGINT NOT NULL AUTO_INCREMENT,
  `OAUserId` BIGINT NOT NULL DEFAULT -1,
  `name` BIGINT NOT NULL,
  `typeId` BIGINT NOT NULL,
  ...
  `updatedBy` VARCHAR(255) NOT NULL,
  PRIMARY KEY (`ID`),
  INDEX `idx_typeTemplate_deleted` (`deleted` ASC) ,
  INDEX `idx_typeTemplate_OAUserId` (`OAUserId` ASC) ,
  CONSTRAINT `fk_typeTemplate_name_dictionary_contentId`
    FOREIGN KEY (`name`)
    REFERENCES `questionnaireDB2019`.`dictionary` (`contentId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_typeTemplate_typeId_type_ID`
    FOREIGN KEY (`typeId`)
    REFERENCES `questionnaireDB2019`.`type` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_typeTemplate_parentId_typeTemplate_ID`
    FOREIGN KEY (`parentId`)
    REFERENCES `questionnaireDB2019`.`typeTemplate` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `questionnaireDB2019`.`typeTemplateTime`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `questionnaireDB2019`.`typeTemplateTime` (
  `ID` BIGINT NOT NULL AUTO_INCREMENT,
  `typeTemplateId` BIGINT NOT NULL,
  PRIMARY KEY (`ID`),
  CONSTRAINT `fk_ttt_typeTemplateId_typeTemplate_ID`
    FOREIGN KEY (`typeTemplateId`)
    REFERENCES `questionnaireDB2019`.`typeTemplate` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `questionnaireDB2019`.`typeTemplateDate`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `questionnaireDB2019`.`typeTemplateDate` (
  `ID` BIGINT NOT NULL AUTO_INCREMENT,
  `typeTemplateId` BIGINT NOT NULL,
  PRIMARY KEY (`ID`),
  CONSTRAINT `fk_ttd_typeTemplateId_typeTemplate_ID`
    FOREIGN KEY (`typeTemplateId`)
    REFERENCES `questionnaireDB2019`.`typeTemplate` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `questionnaireDB2019`.`typeTemplateCheckbox`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `questionnaireDB2019`.`typeTemplateCheckbox` (
  `ID` BIGINT NOT NULL AUTO_INCREMENT,
  `typeTemplateId` BIGINT NOT NULL,
  `minAnswer` INT NOT NULL DEFAULT 0,
  `maxAnswer` INT NOT NULL DEFAULT 0,
  PRIMARY KEY (`ID`),
  CONSTRAINT `fk_ttc_typeTemplateId_typeTemplate_ID`
    FOREIGN KEY (`typeTemplateId`)
    REFERENCES `questionnaireDB2019`.`typeTemplate` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `questionnaireDB2019`.`typeTemplateCheckboxOption`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `questionnaireDB2019`.`typeTemplateCheckboxOption` (
  `ID` BIGINT NOT NULL AUTO_INCREMENT,
  `parentTableId` BIGINT NOT NULL,
  `description` BIGINT NOT NULL,
  `order` INT NOT NULL DEFAULT 0,
  ...
  PRIMARY KEY (`ID`),
  CONSTRAINT `fk_ttco_parentTableId_typeTemplateCheckbox_ID`
    FOREIGN KEY (`parentTableId`)
    REFERENCES `questionnaireDB2019`.`typeTemplateCheckbox` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ttco_description_dictionary_contentId`
    FOREIGN KEY (`description`)
    REFERENCES `questionnaireDB2019`.`dictionary` (`contentId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `questionnaireDB2019`.`typeTemplateLabel`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `questionnaireDB2019`.`typeTemplateLabel` (
  `ID` BIGINT NOT NULL AUTO_INCREMENT,
  `typeTemplateId` BIGINT NOT NULL,
  `displayIntensity` INT NOT NULL DEFAULT 0,
  `pathImage` VARCHAR(512) NOT NULL,
  PRIMARY KEY (`ID`),
  CONSTRAINT `fk_ttl_typeTemplateId_typeTemplate_ID`
    FOREIGN KEY (`typeTemplateId`)
    REFERENCES `questionnaireDB2019`.`typeTemplate` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `questionnaireDB2019`.`typeTemplateRadioButton`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `questionnaireDB2019`.`typeTemplateRadioButton` (
  `ID` BIGINT NOT NULL AUTO_INCREMENT,
  `typeTemplateId` BIGINT NOT NULL,
  PRIMARY KEY (`ID`),
  CONSTRAINT `fk_ttrb_typeTemplateId_typeTemplate_ID`
    FOREIGN KEY (`typeTemplateId`)
    REFERENCES `questionnaireDB2019`.`typeTemplate` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `questionnaireDB2019`.`typeTemplateTextBox`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `questionnaireDB2019`.`typeTemplateTextBox` (
  `ID` BIGINT NOT NULL AUTO_INCREMENT,
  `typeTemplateId` BIGINT NOT NULL,
  PRIMARY KEY (`ID`),
  CONSTRAINT `fk_tttb_typeTemplateId_typeTemplate_ID`
    FOREIGN KEY (`typeTemplateId`)
    REFERENCES `questionnaireDB2019`.`typeTemplate` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `questionnaireDB2019`.`typeTemplateTriggerWord`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `questionnaireDB2019`.`typeTemplateTriggerWord` (
  `ID` BIGINT NOT NULL AUTO_INCREMENT,
  `parentTableId` BIGINT NOT NULL,
  `description` BIGINT NOT NULL,
  `order` INT NOT NULL DEFAULT 0,
  PRIMARY KEY (`ID`),
  CONSTRAINT `fk_tttw_parentTableId_typeTemplateTextBox_ID`
    FOREIGN KEY (`parentTableId`)
    REFERENCES `questionnaireDB2019`.`typeTemplateTextBox` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tttw_description_dictionnary_contentId`
    FOREIGN KEY (`description`)
    REFERENCES `questionnaireDB2019`.`dictionary` (`contentId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `questionnaireDB2019`.`typeTemplateSlider`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `questionnaireDB2019`.`typeTemplateSlider` (
  `ID` BIGINT NOT NULL AUTO_INCREMENT,
  `typeTemplateId` BIGINT NOT NULL,
  `minValue` FLOAT NOT NULL,
  `maxValue` FLOAT NOT NULL,
  ...
  `increment` FLOAT NOT NULL,
  PRIMARY KEY (`ID`),
  CONSTRAINT `fk_tts_typeTemplateId_typeTemplate_ID`
    FOREIGN KEY (`typeTemplateId`)
    REFERENCES `questionnaireDB2019`.`typeTemplate` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tts_minContent_dictionary_contentId`
    FOREIGN KEY (`minCaption`)
    REFERENCES `questionnaireDB2019`.`dictionary` (`contentId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tts_maxContent_dictionary_contentId`
    FOREIGN KEY (`maxCaption`)
    REFERENCES `questionnaireDB2019`.`dictionary` (`contentId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `questionnaireDB2019`.`typeTemplateLabelOption`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `questionnaireDB2019`.`typeTemplateLabelOption` (
  `ID` BIGINT NOT NULL AUTO_INCREMENT,
  `parentTableId` BIGINT NOT NULL,
  `description` BIGINT NOT NULL,
  `posInitX` INT NOT NULL DEFAULT 0,
  ...
  `order` INT NOT NULL DEFAULT 0,
  PRIMARY KEY (`ID`),
  CONSTRAINT `fk_ttlo_parentTableId_typeTemplateLabel_ID`
    FOREIGN KEY (`parentTableId`)
    REFERENCES `questionnaireDB2019`.`typeTemplateLabel` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ttlo_description_dictionary_contentId`
    FOREIGN KEY (`description`)
    REFERENCES `questionnaireDB2019`.`dictionary` (`contentId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `questionnaireDB2019`.`typeTemplateRadioButtonOption`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `questionnaireDB2019`.`typeTemplateRadioButtonOption` (
  `ID` BIGINT NOT NULL AUTO_INCREMENT,
  `parentTableId` BIGINT NOT NULL,
  `description` BIGINT NOT NULL,
  `order` INT NOT NULL DEFAULT 0,
  PRIMARY KEY (`ID`),
  CONSTRAINT `fk_ttrbo_parentTableId_typeTemplateRadioButton_ID`
    FOREIGN KEY (`parentTableId`)
    REFERENCES `questionnaireDB2019`.`typeTemplateRadioButton` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ttrbo_description_dictionary_contentId`
    FOREIGN KEY (`description`)
    REFERENCES `questionnaireDB2019`.`dictionary` (`contentId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
